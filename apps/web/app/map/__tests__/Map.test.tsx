...
import { useGetLibsByISBN, useSearchBook } from "@workspace/data-access"
import { toast } from "sonner"

// Mock child components to isolate Map component logic
jest.mock("../_components/MapSidebar", () => {
  const MockMapSidebar = () => <div data-testid="map-sidebar">MapSidebar</div>;
  MockMapSidebar.displayName = "MockMapSidebar";
  return MockMapSidebar;
});
jest.mock("../_components/MapCanvas", () => {
  const MockMapCanvas = () => <div data-testid="map-canvas">MapCanvas</div>;
  MockMapCanvas.displayName = "MockMapCanvas";
  return MockMapCanvas;
});
jest.mock("@/components/Loading", () => {
  const MockLoadingScreen = () => (
    <div data-testid="loading-screen">LoadingScreen</div>
  );
  MockLoadingScreen.displayName = "MockLoadingScreen";
  return MockLoadingScreen;
});
jest.mock("@/components/Error", () => {
  const MockErrorScreen = ({
    resetErrorBoundary,
  }: {
  ...
  MockErrorScreen.displayName = "MockErrorScreen";
  return MockErrorScreen;
});
